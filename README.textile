...
Moves horizontal scrollbar by <code>x</code> pixels. Rules are the same as for scrollToX.
...
Moves vertical scrollbar by <code>y</code> pixels.  Rules are the same as for scrollToY.
