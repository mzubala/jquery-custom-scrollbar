...
You can download the latest version "here":https://github.com/mzubala/jquery-custom-scrollbar/raw/master/build/jquery-custom-scrollbar-0.5.0.zip
...
* <code>scrollDirection</code> - string that can take following 4 values: <code>left</code>, <code>right</right>, <code>up</code>, <code>down</right> - indicates what direction the scrollbar was moved in
