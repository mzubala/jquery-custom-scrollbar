...
You can download the latest version "here":https://github.com/mzubala/jquery-custom-scrollbar/raw/master/build/jquery-custom-scrollbar-0.0.1.zip

h2. Demos

In <code>demos</code> folder of this repo, there are some example usages of custom scrollbar and its api.
