...
* <code>scrollDirection</code> - string that can take following 4 values: <code>left</code>, <code>right</right>, <code>up</code>, <code>down</code> - indicates what direction the scrollbar was moved in
